...
Rep is a purpose-driven Rolodex to help us accelerate our top priorities. We connect people with mentors and community opportunities based on shared values.

iOS, Android, and web clients on a Python/Flask + PostgreSQL backend. Live at https://repsomething.com. 

## Licensing status

Rep's source code is **published, not licensed** — you may view and download it to evaluate the architecture. No rights to modify, deploy, or redistribute are granted at this time. See [NOTICE.md](NOTICE.md) for details.
...
By using Rep, you acknowledge and agree to uphold these standards. Before proceeding, you must confirm acceptance.
...
- Users may request deletion of their account and associated private data by contacting rep@repsomething.com
...
To exercise these rights, please contact us at rep@repsomething.com.
...
📧 rep@repsomething.com  
🌐 [www.repsomething.com](https://www.repsomething.com)
